...
Base.similar(vmsum::VectorMajoranaSum) = VectorMajoranaSum(PropagationBase.nsites(vmsum), is_spinful(vmsum), Base.similar(vmsum.terms), Base.similar(vmsum.coeffs))
